...
\\
\\
Choose \(\delta = min\left\{\frac{\mathcal{E}}{4},2\right\}\).
\\
\\
\begin{align*}
  |x^2 + x - 2| &= |(x-1)(x-2)| \\
...
From our definition, we already have \(|x-1| < \delta \leq \frac{\mathcal{E}}{4}\). So,
\\
\begin{align*}
  |x-2| &= |x-1+3| \\
  &= |(x-1)+3| \\
...
By the triange inequality. Now using \(|x-1| < \delta\), with \(\delta = min\left\{\frac{\mathcal{E}}{4},2\right\}\), we get
...
\end{align*}
From the definition of the limit, we have some \(\delta > 0\) such that \(\forall x \in \mathcal{R}\), \(0<|x|<\delta\), we have \(x \in D(f)\) and \(|f(x) - 1| < \frac{1}{3}\).
\\
\begin{align*}
	|f(x) - 1| &< \frac{1}{3} \\
